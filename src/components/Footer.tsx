...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#1B0F31] text-[rgba(246,236,201,0.7)]" style={{ padding: "64px 0 40px", fontSize: 14 }}>
      <div className="container mx-auto px-6">
        <div className="grid gap-12 md:grid-cols-[1.4fr_1fr_1fr_1fr]">
          ...
          <div>
            <div className="mb-5">
              <svg
                ...
                viewBox="0 0 115.87 20.94"
                xmlns="http://www.w3.org/2000/svg"
                aria-label="Lyric Genie"
              >
                <path fill={CREAM} d="M25.29,6.43v6.06h5.61v2.01h-8.14V6.43h2.53Z" />
                <path fill={CREAM} d="M32.84,11.38l-4.32-4.95h3.14l2.51,2.97,2.55-2.97h2.85l-4.2,4.95v3.12h-2.53v-3.12Z" />
                <path
                  fill={CREAM}
                ...
                />
                <path fill={CREAM} d="M53.53,14.5h-2.53V6.43h2.53v8.07Z" />
                <path
                  fill={CREAM}
                ...
                />
                <path fill={CREAM} d="M90.61,6.43v1.83h-6.01v1.19h5.87v1.84h-5.87v1.32h6.12v1.88h-8.61V6.43h8.51Z" />
                <path fill={CREAM} d="M94.6,6.43l5.15,5.08v-5.08h2.5v8.07h-2.5l-5.48-5.35v5.35h-2.5V6.43h2.82Z" />
                <path fill={CREAM} d="M106.02,14.5h-2.53V6.43h2.53v8.07Z" />
                <path fill={CREAM} d="M115.76,6.43v1.83h-6.01v1.19h5.87v1.84h-5.87v1.32h6.12v1.88h-8.61V6.43h8.51Z" />
                <path
                  fill={CREAM}
                ...
                />
                <path fill={CREAM} d="M16.41,2.61v-.04l-.17-.54-1.1.3v1.65c-.74-.16-1.32.68-.83,1.29.45.58,1.35.3,1.44-.41v-2.06s.67-.19.67-.19Z" />
                <path
                  fill={CREAM}
            ...
            <p className="mb-5 max-w-[320px] text-sm leading-[1.55] text-[rgba(246,236,201,0.65)]">
              Your all-in-one songwriting notepad. Built by professional songwriters in LA.
            </p>
            <div className="flex gap-2.5">
              <a
                href="https://instagram.com/lyricgenieapp"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Instagram"
                className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-[rgba(246,236,201,0.08)] text-[#F6ECC9] transition-colors hover:bg-[rgba(246,236,201,0.16)]"
              >
                <Instagram className="h-4 w-4" />
              </a>
              <a
                href="https://tiktok.com/@lyricgenieapp"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="TikTok"
                className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-[rgba(246,236,201,0.08)] text-[#F6ECC9] transition-colors hover:bg-[rgba(246,236,201,0.16)]"
          ...
          {/* Product */}
          <div>
            <h5 className="mb-4 text-xs font-bold uppercase tracking-[0.12em] text-[#F6ECC9]">Product</h5>
          ...
          {/* Company */}
          <div>
            <h5 className="mb-4 text-xs font-bold uppercase tracking-[0.12em] text-[#F6ECC9]">Company</h5>
            <ul className="flex flex-col">
              <li>
                <Link
                  to="/about"
          ...
          {/* Legal */}
          <div>
            <h5 className="mb-4 text-xs font-bold uppercase tracking-[0.12em] text-[#F6ECC9]">Legal</h5>
            <ul className="flex flex-col">
              <li>
                <Link
                  to="/privacy-policy"
        ...
        <div
          className="mt-13 flex flex-col items-center justify-between gap-2 border-t border-[rgba(246,236,201,0.15)] pt-7 text-xs text-[rgba(246,236,201,0.65)] md:flex-row"
          style={{ marginTop: 52 }}
        >
          <span>&copy; {currentYear} Edan Dover Inc. All rights reserved.</span>
