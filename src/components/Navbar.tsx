...
const Navbar = () => {
  ...
  // The nav transitions from white-on-cream to purple-on-cream once
  // the user scrolls past the announcement strip OR opens the mobile
  // menu. The mobile menu has a full-bleed purple background, so the
  // navbar above it should match the menu's color theme rather than
  // contrast against it (a white bar above a purple sheet looks
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex items-center justify-between h-20 gap-4">
            ...
            <a href="/" className="flex items-center gap-2">
              ...
              >
                <path
                  className={`transition-colors duration-300 ${navIsDark ? "fill-[#F6ECC9]" : "fill-[#1E1324]"}`}
            ...
            {/* Mobile Menu Button */}
            <button
              className={`md:hidden p-2 transition-colors ${navIsDark ? "text-[#F6ECC9]" : "text-[#1E1324]"}`}
