        ...
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-between h-20">
            ...
            <a href="/" className="flex items-center gap-2">
              ...
              >
                <path
                  className={`transition-colors duration-300 ${isScrolled ? "fill-[#F6ECC9]" : "fill-[#1E1324]"}`}
            ...
            {/* Mobile Menu Button */}
            <button
              className={`md:hidden p-2 transition-colors ${isScrolled ? "text-[#F6ECC9]" : "text-[#1E1324]"}`}
